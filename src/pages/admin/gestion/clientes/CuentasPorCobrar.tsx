    ...
    <div className="flex flex-col gap-4 animate-in fade-in duration-300 h-full min-h-0">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-6">
          <h3 className="text-lg font-semibold text-white">Estado de Pagos y Adeudos</h3>
          <div className="px-5 py-2 rounded-xl border border-rose-500/20 bg-rose-500/10 flex items-center gap-4">
            <div className="flex flex-col items-center justify-center">
              <p className="text-[11px] font-medium text-rose-500 uppercase tracking-wider mb-0.5">Total Adeudos</p>
              <p className="text-xl font-bold text-rose-500 leading-none">$1,250.00</p>
            </div>
        ...
        <div className="flex items-center gap-3">
          <div className="relative w-64">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 bg-slate-900 border border-white/10 rounded-lg text-sm text-white placeholder:text-slate-500 focus:outline-none focus:border-rose-500 transition-colors"
            />
          </div>
          <button 
            onClick={() => setModalDeudaOpen(true)}
            className="px-4 py-2 bg-orange-600 hover:bg-orange-700 text-white text-sm font-medium rounded-lg transition-colors flex items-center justify-center gap-2 whitespace-nowrap shadow-lg shadow-orange-900/20"
          >
