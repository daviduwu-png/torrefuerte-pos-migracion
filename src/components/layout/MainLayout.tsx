  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="flex-1 flex flex-col min-w-0 relative">
        ...
        <div className="absolute top-0 left-0 w-full h-96 bg-blue-600/10 blur-[100px] pointer-events-none -z-10" />
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-purple-600/10 blur-[120px] pointer-events-none -z-10" />

        {/* Header - Card Style */}
        <header className="w-full px-8 pt-6 pb-2 z-10 flex-shrink-0">
          <div className="w-full glass-panel p-5 rounded-2xl flex items-center justify-between border border-white/10 shadow-2xl bg-slate-900/60 backdrop-blur-xl">
            {/* Page Title & Icon - Left Side */}
            <div className="flex items-center gap-5">
              <div
                className={`p-3.5 rounded-xl ${colors.bg} ${colors.border} border backdrop-blur-sm shadow-inner`}
              >
        ...
        {/* Page Content */}
        <main className="flex-1 px-8 pb-8 overflow-y-auto py-6 custom-scrollbar scroll-smooth">
          <Outlet />
        </main>
